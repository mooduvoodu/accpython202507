...
# ───────────────────────────────────────────────────────────────────────────────
customers    = pd.read_csv('/workspaces/accpython202507/exampledata/customers.csv',
                           sep='|', encoding='latin1')
orderheader  = pd.read_csv('/workspaces/accpython202507/exampledata/orderheader.csv',
                           sep='|', encoding='latin1')
orderdetails = pd.read_csv('/workspaces/accpython202507/exampledata/orderdetails.csv',
                           sep='|', encoding='latin1')
product      = pd.read_csv('/workspaces/accpython202507/exampledata/product.csv',
                           sep='|', encoding='latin1')
...
def title_case(name):
    return name.title()                # capitalizes each word
